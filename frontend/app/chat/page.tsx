                ...
                <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
                    ...
                    <div className="glass-card p-2 flex items-center gap-2">
                        ...
                        <input
                            ...
                            className="flex-1 bg-transparent border-none text-white placeholder-white/60 focus:outline-none px-2 py-2.5"
                            disabled={loading}
                        />
                        <button
                            type="submit"
                            disabled={loading || (!input.trim() && !selectedFile)}
                            className="bg-gradient-to-r from-blue-500 to-purple-600 text-white p-2.5 sm:px-5 sm:py-2.5 rounded-xl font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed shrink-0 flex items-center justify-center gap-2"
                        >
